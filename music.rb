...
list_artists({:ed_sheeran => "Thinking Out Loud", :taylor_swift => "Style", :silent => "Watch Me", :selena_gomez => "Good For You", :mark_ronson => "Uptown Funk!", :andy_grammer => "Honey I'm Good", :maroon_five => "Sugar"})
